...
scoreboard players set %the_beber_BV_found_nentry% the_beber_BV_found_ne 1
...
data modify storage the_beber_bonk_villager:gossip_system Target set from entity @n[tag=the_beber_BV_toForgive] UUID

# Test last element, if it is the correct entry:
execute store success score %the_beber_BV_found_nentry% the_beber_BV_found_ne run data modify storage the_beber_bonk_villager:gossip_system Target set from storage the_beber_bonk_villager:gossip_system GossipsCopy[-1].Target
execute if score %the_beber_BV_found_nentry% the_beber_BV_found_ne matches 0 store success score %the_beber_BV_found_nentry% the_beber_BV_found_ne run data modify storage the_beber_bonk_villager:gossip_system GossipType set from storage the_beber_bonk_villager:gossip_system GossipsCopy[-1].Type
