...
execute if score #loaded bv.entityid matches 1 run function eingruenesbeb.bonk_villager:hit_detection/_check_for_id_assignment
execute if predicate eingruenesbeb.bonk_villager:restock_time run function eingruenesbeb.bonk_villager:_bonked_restock
execute if predicate eingruenesbeb.bonk_villager:new_day run execute as @e[tag=bv.bonked_state] run data modify entity @s RestocksToday set value 0
