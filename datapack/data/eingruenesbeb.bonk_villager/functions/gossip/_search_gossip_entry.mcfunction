# as: @e, if: score @s eingruenesbeb.bv.entityid = $hit eingruenesbeb.bv.entityid, at: [worldspawn]
...
data modify storage eingruenesbeb.bonk_villager:gossip_system Target set from entity @p[sort=nearest, tag=eingruenesbeb.bv.to_forgive] UUID
